...
print("Correct next-in-sequence predictions in testing =", f"{Correct_Predictions / Number_of_Testing_Samples * 100 : 0.2f}%")
...
print(f"Average ratio of fully predicted sequence lengths to their actual lengths: {(Sum_Full_Lengths / Completed_Predictions) / Full_Length}")